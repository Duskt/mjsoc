...
interface IconButtonParameters extends CircleButtonParameters {
    icon: 'fill' | 'shuffle' | 'reset' | 'trash' | 'save' | 'undo' | 'settings' | 'download';
}

// <!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
export default class IconButton extends Component<'button'> {
    svg: SVGSVGElement;
    path: SVGPathElement;
    constructor(params: IconButtonParameters) {
        super({
            tag: 'button',
            classList: ['icon-button'],
            ...params,
